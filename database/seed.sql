...
INSERT INTO suppliers (SupplierName, ContactName, Address, City, PostalCode, Country, Phone) VALUES
    ('Công ty Công nghệ ABC', 'Nguyễn Văn An', '01 Nguyễn Huệ', 'TP. Hồ Chí Minh', '700000', 'Việt Nam', '0901234567'),
    ('Công ty Thiết bị XYZ', 'Trần Minh Bình', '25 Lê Lợi', 'Đà Nẵng', '550000', 'Việt Nam', '0912345678');

INSERT INTO customers (CustomerName, ContactName, Address, City, PostalCode, Country) VALUES
    ('Nguyễn Minh Anh', 'Nguyễn Minh Anh', '12 Nguyễn Trãi', 'TP. Hồ Chí Minh', '700000', 'Việt Nam'),
    ('Trần Thanh Hà', 'Trần Thanh Hà', '35 Hùng Vương', 'Cần Thơ', '900000', 'Việt Nam'),
    ('Lê Quốc Bảo', 'Lê Quốc Bảo', '18 Lê Lợi', 'Trà Vinh', '870000', 'Việt Nam');
...
INSERT INTO products (ProductCode, ProductName, Description, Unit, Price, StockQuantity, IsActive, SupplierID, CategoryID) VALUES
    ('SP001', 'Điện thoại Smartphone A', 'Điện thoại thông minh màn hình lớn, phù hợp nhu cầu sử dụng hằng ngày.', 'Chiếc', 8500000.00, 20, TRUE, 1, 1),
    ('SP002', 'Laptop B', 'Máy tính xách tay phục vụ học tập và làm việc.', 'Chiếc', 18500000.00, 10, TRUE, 2, 2),
...
INSERT INTO orderdetail (Quantity, UnitPrice, OrderID, ProductID) VALUES
    (1, 8500000.00, 1, 1),
    (2, 450000.00, 1, 3),
    (1, 18500000.00, 2, 2),
    (2, 450000.00, 3, 3);